              ...
              return (
                ...
                >
                  <div>
                    ...
                    <Link
                      href={`/services/${service.anchor}`}
                      className="mt-8 inline-flex items-center gap-2 rounded-full border border-border bg-surface/60 px-5 py-2.5 text-sm font-medium transition hover:border-brand-2/60 hover:bg-surface"
                    >
                      {t("detailLink")}
